...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x9B986F93U */
    CFI_PROLOGUE_TAG(0x9B986F93U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9B986F93U);
    #endif
    return checksum;
}
...
void startPstorage()
{
    ...
    #if CFI_PROTECT
    /* CFI: default, tag=0x049EA890U */
    CFI_PROLOGUE_TAG(0x049EA890U);
    #endif
    ...
    while (run_pstorage)
    {
        ...
        if (file == NULL) 
        {
            ...
            openplc_log(log_msg);
            #if CFI_PROTECT
            CFI_EPILOGUE_TAG_PAC(0x049EA890U);
            #endif
            return;
        }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x09B939CDU */
    CFI_PROLOGUE_TAG(0x09B939CDU);
    #endif
    ...
    if (file == NULL) 
    {
        ...
        pstorage_read = true;
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x09B939CDU);
        #endif
        return 0;
    }
