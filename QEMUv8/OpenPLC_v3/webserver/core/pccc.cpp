...
uint16_t processPCCCMessage(unsigned char *buffer, int buffer_size)
{
    /* Variables */
    #if CFI_PROTECT
    /* CFI: default, tag=0x440DADBDU */
    CFI_PROLOGUE_TAG(0x440DADBDU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x440DADBDU);
    #endif
...
{	
    /*Variables*/
    #if CFI_PROTECT
    /* CFI: default, tag=0xFB2AEE15U */
    CFI_PROLOGUE_TAG(0xFB2AEE15U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xFB2AEE15U);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xEB57D0BAU */
    CFI_PROLOGUE_TAG(0xEB57D0BAU);
    #endif
    ...
    {	
        ...
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0xEB57D0BAU);
        #endif
...
uint16_t Protected_Logical_Read_Reply(pccc_header header, unsigned char *buffer, int buffer_size)
{
    /*Variables*/
    #if CFI_PROTECT
    /* CFI: default, tag=0xC35263F0U */
    CFI_PROLOGUE_TAG(0xC35263F0U);
    #endif
    ...
    else
    {
        ...
        openplc_log(log_msg); 
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0xC35263F0U);
        #endif
        return -1;
    }//return length as -1 to signify that the CMD Code/Function Code was not recognize
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x33CD748FU */
    CFI_PROLOGUE_TAG(0x33CD748FU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x33CD748FU);
    #endif
    return returnValue;
}
//-----------------------------------------------------------------------------
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xD33D29AAU */
    CFI_PROLOGUE_TAG(0xD33D29AAU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xD33D29AAU);
    #endif
    return returnValue;
}
