...
int configureEthercat(){
    #if CFI_PROTECT
    /* CFI: default, tag=0x292AC034U */
    CFI_PROLOGUE_TAG(0x292AC034U);
    #endif

    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x292AC034U);
    #endif
    return 1;
}
//-----------------------------------------------------------------------------
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x79FF24A2U */
    CFI_PROLOGUE_TAG(0x79FF24A2U);
    #endif

    startServer(modbus_port, MODBUS_PROTOCOL);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x79FF24A2U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x48300CB4U */
    CFI_PROLOGUE_TAG(0x48300CB4U);
    #endif

    dnp3StartServer(dnp3_port);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x48300CB4U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x62C8B725U */
    CFI_PROLOGUE_TAG(0x62C8B725U);
    #endif

    startServer(enip_port, ENIP_PROTOCOL);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x62C8B725U);
    #endif
    return nullptr;
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x9A2AFE1FU */
    CFI_PROLOGUE_TAG(0x9A2AFE1FU);
    #endif

    startPstorage();
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9A2AFE1FU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x6E64AAF0U */
    CFI_PROLOGUE_TAG(0x6E64AAF0U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x6E64AAF0U);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x0E9ED3D2U */
    CFI_PROLOGUE_TAG(0x0E9ED3D2U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x0E9ED3D2U);
    #endif
    return argument;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x32943A2FU */
    CFI_PROLOGUE_TAG(0x32943A2FU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x32943A2FU);
    #endif
    return socket_fd;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x2AA38190U */
    CFI_PROLOGUE_TAG(0x2AA38190U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x2AA38190U);
    #endif
    return client_fd;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x9F6F51FEU */
    CFI_PROLOGUE_TAG(0x9F6F51FEU);
    #endif

    bzero(buffer, 1024);
    int n = read(client_fd, buffer, 1024);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9F6F51FEU);
    #endif
    return n;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x6BB60AC9U */
    CFI_PROLOGUE_TAG(0x6BB60AC9U);
    #endif
    ...
    if (processing_command)
    {
        ...
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x6BB60AC9U);
        #endif
        return;
    }
    ...
    else if (strncmp(buffer, "start_modbus(", 13) == 0)
    {
        ...
        run_modbus = 1;
        #if CFI_PROTECT
        /* CFI FWD: pthread_create -> 'modbusThread' */
        cfi_register_target((uint64_t)(uintptr_t)modbusThread, 0xBC1381DEU);
        #endif
    ...
    else if (strncmp(buffer, "start_dnp3(", 11) == 0)
    {
        ...
        run_dnp3 = 1;
        #if CFI_PROTECT
        /* CFI FWD: pthread_create -> 'dnp3Thread' */
        cfi_register_target((uint64_t)(uintptr_t)dnp3Thread, 0x32E86533U);
        #endif
    ...
    else if (strncmp(buffer, "start_enip(", 11) == 0)
    {
        ...
        run_enip = 1;
        #if CFI_PROTECT
        /* CFI FWD: pthread_create -> 'enipThread' */
        cfi_register_target((uint64_t)(uintptr_t)enipThread, 0xEBBC0ECDU);
        #endif
    ...
    else if (strncmp(buffer, "start_pstorage(", 15) == 0)
    {
        ...
        run_pstorage = 1;
        #if CFI_PROTECT
        /* CFI FWD: pthread_create -> 'pstorageThread' */
        cfi_register_target((uint64_t)(uintptr_t)pstorageThread, 0x9C501168U);
        #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xCC49088FU */
    CFI_PROLOGUE_TAG(0xCC49088FU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xCC49088FU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x12D0F6D8U */
    CFI_PROLOGUE_TAG(0x12D0F6D8U);
    #endif
    ...
    pthread_exit(NULL);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x12D0F6D8U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x39900A91U */
    CFI_PROLOGUE_TAG(0x39900A91U);
    #endif
    ...
    while(run_openplc)
    {
        ...
        else
        {
            ...
            #if CFI_PROTECT
            /* CFI FWD: pthread_create -> 'handleConnections_interactive' */
            cfi_register_target((uint64_t)(uintptr_t)handleConnections_interactive, 0x87D6D45BU);
            #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x39900A91U);
    #endif
}
