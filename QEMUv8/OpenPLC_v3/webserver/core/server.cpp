...
{
   #if CFI_PROTECT
   /* CFI: default, tag=0xB9E31F57U */
   CFI_PROLOGUE_TAG(0xB9E31F57U);
   #endif
   ...
   #if CFI_PROTECT
   CFI_EPILOGUE_TAG_PAC(0xB9E31F57U);
   #endif
   return err;
}
...
{
   #if CFI_PROTECT
   /* CFI: default, tag=0x6F1D74FBU */
   CFI_PROLOGUE_TAG(0x6F1D74FBU);
   #endif
   ...
   #if CFI_PROTECT
   CFI_EPILOGUE_TAG_PAC(0x6F1D74FBU);
   #endif
}
...
{
   #if CFI_PROTECT
   /* CFI: default, tag=0x63F015DAU */
   CFI_PROLOGUE_TAG(0x63F015DAU);
   #endif
   ...
   #if CFI_PROTECT
   CFI_EPILOGUE_TAG_PAC(0x63F015DAU);
   #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xB275D45AU */
    CFI_PROLOGUE_TAG(0xB275D45AU);
    #endif
    ...
    if (socket_fd<0)
    {
        ...
        openplc_log(log_msg);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0xB275D45AU);
        #endif
        return -1;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xEDB69E54U */
    CFI_PROLOGUE_TAG(0xEDB69E54U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xEDB69E54U);
    #endif
    return client_fd;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xC49DD9FCU */
    CFI_PROLOGUE_TAG(0xC49DD9FCU);
    #endif

    bzero(buffer, NET_BUFFER_SIZE);
    int n = read(client_fd, buffer, NET_BUFFER_SIZE);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xC49DD9FCU);
    #endif
    return n;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x58181B32U */
    CFI_PROLOGUE_TAG(0x58181B32U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x58181B32U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x6CB42893U */
    CFI_PROLOGUE_TAG(0x6CB42893U);
    #endif
    ...
    pthread_exit(NULL);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x6CB42893U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xA43B27ACU */
    CFI_PROLOGUE_TAG(0xA43B27ACU);
    #endif
    ...
    while(*run_server)
    {
        ...
        else
        {
            ...
            #if CFI_PROTECT
            /* CFI FWD: pthread_create -> 'handleConnections' */
            cfi_register_target((uint64_t)(uintptr_t)handleConnections, 0x0D6F3A64U);
            #endif
    ...
    openplc_log(log_msg);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xA43B27ACU);
    #endif
}
