...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x9D5CE365U */
    CFI_PROLOGUE_TAG(0x9D5CE365U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9D5CE365U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x632CC4B1U */
    CFI_PROLOGUE_TAG(0x632CC4B1U);
    #endif
    ...
    nanosleep(&ts, NULL);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x632CC4B1U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x770E1D1CU */
    CFI_PROLOGUE_TAG(0x770E1D1CU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x770E1D1CU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x58A54A82U */
    CFI_PROLOGUE_TAG(0x58A54A82U);
    #endif

    startInteractiveServer(43628);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x58A54A82U);
    #endif
    return NULL;
}
...
void disableOutputs()
{
    ...
    #if CFI_PROTECT
    /* CFI: default, tag=0xAC1EAC69U */
    CFI_PROLOGUE_TAG(0xAC1EAC69U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xAC1EAC69U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x29B39A3EU */
    CFI_PROLOGUE_TAG(0x29B39A3EU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x29B39A3EU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x713EF583U */
    CFI_PROLOGUE_TAG(0x713EF583U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x713EF583U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xDC13DA84U */
    CFI_PROLOGUE_TAG(0xDC13DA84U);
    #endif

    rpi_modbus_rts_pin = pin;
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xDC13DA84U);
    #endif
}
