...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x661D4D1DU */
    CFI_PROLOGUE_TAG(0x661D4D1DU);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xE0B9F183U */
    CFI_PROLOGUE_TAG(0xE0B9F183U);
    #endif
    ...
    *shm_out_ptr = mmap(NULL, shm_out_size, PROT_READ | PROT_WRITE, MAP_SHARED, shm_out_fd, 0);
    ...
    pthread_t tid;
    #if CFI_PROTECT
    /* CFI: Register thread entry point 'runner_thread' */
    cfi_register_target((uint64_t)(uintptr_t)runner_thread, 0xE3BC4E3CU);
    #endif
