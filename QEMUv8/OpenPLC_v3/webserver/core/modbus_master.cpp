...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x668BDA8CU */
    CFI_PROLOGUE_TAG(0x668BDA8CU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x668BDA8CU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x9834E30AU */
    CFI_PROLOGUE_TAG(0x9834E30AU);
    #endif
    ...
    return(atoi(temp));
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9834E30AU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x8AF48103U */
    CFI_PROLOGUE_TAG(0x8AF48103U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x8AF48103U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xC12A10D7U */
    CFI_PROLOGUE_TAG(0xC12A10D7U);
    #endif
    ...
    //*/
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xC12A10D7U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xB86F8D07U */
    CFI_PROLOGUE_TAG(0xB86F8D07U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xB86F8D07U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xCDB0C3FBU */
    CFI_PROLOGUE_TAG(0xCDB0C3FBU);
    #endif
    ...
    if (num_devices > 0)
    {
        pthread_t thread;
        #if CFI_PROTECT
        /* CFI FWD: pthread_create -> 'querySlaveDevices' */
        cfi_register_target((uint64_t)(uintptr_t)querySlaveDevices, 0xB2BEF04EU);
        #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xCDB0C3FBU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x729A758FU */
    CFI_PROLOGUE_TAG(0x729A758FU);
    #endif
    ...
    pthread_mutex_unlock(&ioLock);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x729A758FU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xB05D34BAU */
    CFI_PROLOGUE_TAG(0xB05D34BAU);
    #endif
    ...
    pthread_mutex_unlock(&ioLock);
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xB05D34BAU);
    #endif
}
