...
{	
        #if CFI_PROTECT
        /* CFI: default, tag=0x747283BFU */
        CFI_PROLOGUE_TAG(0x747283BFU);
        #endif
        ...
        if (header->command[0] == 65 || header->command[0] == 0x70)
        {
            ...
            #if CFI_PROTECT
            CFI_EPILOGUE_TAG_PAC(0x747283BFU);
            #endif
            return 0;
        }
...
{	
    #if CFI_PROTECT
    /* CFI: default, tag=0x1ADB266AU */
    CFI_PROLOGUE_TAG(0x1ADB266AU);
    #endif

    uint16_t dataLength = ((uint16_t)header->length[1] << 8) | (uint16_t)header->length[0];
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x1ADB266AU);
    #endif
    return dataLength;
}
...
{	
    ...
    #if CFI_PROTECT
    /* CFI: default, tag=0x3A712134U */
    CFI_PROLOGUE_TAG(0x3A712134U);
    #endif

    if (buffer_size < ENIP_MIN_LENGTH)
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x3A712134U);
        #endif
        return -1;
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xC33CF2F4U */
    CFI_PROLOGUE_TAG(0xC33CF2F4U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xC33CF2F4U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x364C1FB7U */
    CFI_PROLOGUE_TAG(0x364C1FB7U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x364C1FB7U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xFD27505EU */
    CFI_PROLOGUE_TAG(0xFD27505EU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xFD27505EU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xFE01207EU */
    CFI_PROLOGUE_TAG(0xFE01207EU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xFE01207EU);
    #endif
}
...
{	
    #if CFI_PROTECT
    /* CFI: default, tag=0xE903600BU */
    CFI_PROLOGUE_TAG(0xE903600BU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xE903600BU);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xF07121F0U */
    CFI_PROLOGUE_TAG(0xF07121F0U);
    #endif
    ...
    {	
        ...
        if (newPcccSize == -1)
            #if CFI_PROTECT
            CFI_EPILOGUE_TAG_PAC(0xF07121F0U);
            #endif
...
int sendUnitData(struct enip_header *header, struct enip_data_Connected_0x70 *enipDataConnected_0x70)
{
    ...
    #if CFI_PROTECT
    /* CFI: default, tag=0x7444ABB0U */
    CFI_PROLOGUE_TAG(0x7444ABB0U);
    #endif
    ...
    if (newPcccSize == (uint16_t) -1)
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x7444ABB0U);
        #endif
        return -1;	//error in PCCC.cpp
...
{	
    ...
    #if CFI_PROTECT
    /* CFI: default, tag=0x0681456CU */
    CFI_PROLOGUE_TAG(0x0681456CU);
    #endif
