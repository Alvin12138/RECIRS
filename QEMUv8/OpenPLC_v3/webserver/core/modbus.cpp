...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xD896464DU */
    CFI_PROLOGUE_TAG(0xD896464DU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xD896464DU);
    #endif
    return returnValue;
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xE888F595U */
    CFI_PROLOGUE_TAG(0xE888F595U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xE888F595U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xD4D20831U */
    CFI_PROLOGUE_TAG(0xD4D20831U);
    #endif
    ...
    MessageLength = 9;
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0xD4D20831U);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x41C9F939U */
    CFI_PROLOGUE_TAG(0x41C9F939U);
    #endif
    ...
    if (bufferSize < 12)
    {
        ...
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x41C9F939U);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x1AEB7A7AU */
    CFI_PROLOGUE_TAG(0x1AEB7A7AU);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x1AEB7A7AU);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x07FBE252U */
    CFI_PROLOGUE_TAG(0x07FBE252U);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x07FBE252U);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x268DC2C9U */
    CFI_PROLOGUE_TAG(0x268DC2C9U);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x268DC2C9U);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x375995EBU */
    CFI_PROLOGUE_TAG(0x375995EBU);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x375995EBU);
        #endif
        return;
    }
...
int writeToRegisterWithoutLocking(int position, uint16_t value)
{
    //analog outputs
    #if CFI_PROTECT
    /* CFI: default, tag=0x51C66138U */
    CFI_PROLOGUE_TAG(0x51C66138U);
    #endif
    ...
    {
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x51C66138U);
        #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x91644D5CU */
    CFI_PROLOGUE_TAG(0x91644D5CU);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x91644D5CU);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x1842C2FBU */
    CFI_PROLOGUE_TAG(0x1842C2FBU);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x1842C2FBU);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x3BB544EDU */
    CFI_PROLOGUE_TAG(0x3BB544EDU);
    #endif
    ...
    if (bufferSize < 12)
    {
        ModbusError(buffer, ERR_ILLEGAL_DATA_VALUE);
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x3BB544EDU);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x1361A63AU */
    CFI_PROLOGUE_TAG(0x1361A63AU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x1361A63AU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xF260991CU */
    CFI_PROLOGUE_TAG(0xF260991CU);
    #endif
    ...
    if (varidx >= variableCount || len > (MAX_MB_FRAME - 7))
    {
        ...
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0xF260991CU);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xEB5BC5F9U */
    CFI_PROLOGUE_TAG(0xEB5BC5F9U);
    #endif
    ...
    if (startidx >= variableCount || endidx >= variableCount || startidx > endidx) 
    {
        ...
        mb_frame[8] = MB_DEBUG_ERROR_OUT_OF_BOUNDS;
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0xEB5BC5F9U);
        #endif
        return;
    }
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x60DA4236U */
    CFI_PROLOGUE_TAG(0x60DA4236U);
    #endif
    ...
    if (numIndexes > VARIDX_SIZE)
    {
        ...
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x60DA4236U);
        #endif
        return;
    }
...
void debugGetMd5(unsigned char *mb_frame, void *endianness)
{
    // Check endianness
    #if CFI_PROTECT
    /* CFI: default, tag=0x9115C6DCU */
    CFI_PROLOGUE_TAG(0x9115C6DCU);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x9115C6DCU);
    #endif
}
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x1CDAE4F8U */
    CFI_PROLOGUE_TAG(0x1CDAE4F8U);
    #endif
...
#define MODBUS_HEADER_SIZE 6
    ...
    {
        #if CFI_PROTECT
        CFI_EPILOGUE_TAG_PAC(0x1CDAE4F8U);
        #endif
        return -1;
    }
    do
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x723A4713U */
    CFI_PROLOGUE_TAG(0x723A4713U);
    #endif
    ...
    #if CFI_PROTECT
    CFI_EPILOGUE_TAG_PAC(0x723A4713U);
    #endif
