...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x4FF73BF7U */
    CFI_PROLOGUE_TAG(0x4FF73BF7U);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x3F4F0E03U */
    CFI_PROLOGUE_TAG(0x3F4F0E03U);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0xEC27D56EU */
    CFI_PROLOGUE_TAG(0xEC27D56EU);
    #endif
...
{
    #if CFI_PROTECT
    /* CFI: default, tag=0x0242D32FU */
    CFI_PROLOGUE_TAG(0x0242D32FU);
    #endif

    #if CFI_PROTECT
    CFI_EPILOGUE_TAG(0x0242D32FU);
    #endif
